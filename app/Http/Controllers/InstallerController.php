...
class InstallerController extends Controller
{
    ...
    public function install()
    {
        ...
        $envcontent .= 'APP_AUTHOR="Arsen"' . PHP_EOL;
		...
		$envcontent .= 'APP_METATAGS="dnyHelpRealm, HelpRealm, Arsen, ticket, ticket system, support ticket system, support, system, agent, client, helpdesk"' . PHP_EOL;
