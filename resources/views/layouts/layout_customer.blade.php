...
<html lang="{{ str_replace('_', '-', App::getLocale()) }}">
    ...
    @if (isset($wsobject))
        <body @if ((bool)$wsobject->usebgcolor === false) @if (isset($bgimage->file))style="background-image: url('{{ asset('gfx/backgrounds/' . $bgimage->file) }}');"@endif @else style="background-color: {{ $wsobject->bgcolorcode }}" @endif>
    @else
        <body>
    @endif
