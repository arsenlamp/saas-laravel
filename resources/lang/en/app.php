<?php
    ...
    */
    ...
    return [
        ...
        'ticket_customer_confirm_success' => 'Your e-mail address has been verified. You may now wait until a support agent replies to your ticket. You will get an e-mail notification in case of that event.',
        'ticket_types' => 'Ticket types',
        'ticket_type_add_failed' => 'Failed to add new ticket type',
        'ticket_type_added' => 'Ticket type has been successfully added',
        'ticket_type_not_found' => 'Ticket type not found',
        'ticket_type_deleted' => 'Ticket type has been deleted',
        'ticket_type_id' => 'ID',
        'ticket_type_name' => 'Identifier',
        'ticket_type_created' => 'Created',
        'ticket_type_remove' => 'Remove',
        'ticket_type_create' => 'Add ticket type',
        'ticket_type_input_name' => 'Enter new ticket type name',
        ...
        'install_success' => 'The product has successfully been installed. Please add Twitter and Mailservice variables manually.',
        ...
        'mail_ticket_reply_agent_body' => 'An agent has replied to one of your tickets:',
        'mail_reply_info' => 'Note: You can directly answer by replying to this email (leave the [ID:(hash)] unaltered)!',
